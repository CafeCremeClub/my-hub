...
const ProfilePageContent = () => {
  ...
  if (isError || !data) {
    return (
      <ErrorBox message="Une erreur est survenue lors du chargement de votre profil. Veuillez réessayer plus tard." />
    );
  }

  return (
    <div className="grid grid-cols-8 gap-8">
      <div className="col-span-8 rounded-3xl py-6 px-8 bg-[#F4F9FF] flex xl:flex-row flex-col xl:items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-[#475467]">{data.profession}</p>
          </div>
        </div>
      ...
      <div className="col-span-8 lg:col-span-4 xl:col-span-2 rounded-3xl py-6 px-8 bg-[#F4F9FF] flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-medium text-[#475467]">Localisation</p>
          <div className="flex items-center gap-2">
            <FRIcon />
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-medium text-[#475467]">Linkedin</p>
        ...
        <div className="flex flex-col gap-2">
          <p className="text-sm font-medium text-[#475467]">Whatsapp</p>
          <div className="flex items-center gap-2 cursor-pointer hover:underline">
            <p className="font-semibold text-[#004EEB] tracking-tighter bricolage-grotesque">
              {data.whatsApp}
            </p>
      ...
      <div className="col-span-8 lg:col-span-4 xl:col-span-6 rounded-3xl py-6 px-8 bg-[#F4F9FF] flex flex-col gap-8 h-max">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-[#475467] text-justify">
            {data.bio
              ? data.bio
              : 'Vous pouvez mettre en avant votre expérience, votre secteur d’activité ou vos compétences.'}
          </p>
        </div>
        <div className="flex flex-col gap-5">
          <p className="text-[#101828] text-xl font-semibold tracking-tighter bricolage-grotesque">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm">
                  <p className="text-[#344054]">
                    {data.firstname + ' ' + data.lastname + ' CV'}.pdf
                  </p>
