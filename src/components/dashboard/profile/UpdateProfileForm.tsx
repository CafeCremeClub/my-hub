...
const validationSchema = Yup.object({
  ...
  bio: Yup.string()
    .max(
      MAX_BIO_LENGTH,
      `La bio ne peut pas dépasser ${MAX_BIO_LENGTH} caractères`
    )
    .notRequired(),
  skills: Yup.array()
...
const UpdateProfileForm = ({ data }: UpdateProfileFormProps) => {
  ...
  const { isPending: updateIsPending, mutateAsync: updateProfile } =
    useUpdateProfile();
    ...
    onSubmit: async (values) => {
      try {
        ...
        toast.error('Une erreur est survenue', {
          description:
            'Un problème est survenu lors de la mise à jour de vos informations. Veuillez réessayer plus tard.',
          position: 'bottom-right',
  ...
  return (
    <form className="flex flex-col gap-6 pb-6" onSubmit={formik.handleSubmit}>
      <div className="flex flex-col gap-1">
        <p className="font-semibold text-lg text-[#101828]">Profil</p>
      ...
      <div className="flex flex-col gap-5">
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="firstname" className="md:w-96">
            Prénom
          </Label>
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="lastname" className="md:w-96">
            NOM
          </Label>
          <div className="col-span-2">
            <CustomInput
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="email" className="md:w-96">
            Adresse e-mail
          </Label>
          <div className="col-span-2">
            <CustomInput
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="whatsApp" className="md:w-96">
            Numéro Whatsapp
          </Label>
          <div className="col-span-2">
            <CustomPhoneInput
              ...
              isError={
                formik.touched.whatsApp && formik.errors.whatsApp !== undefined
              }
            />
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="linkedIn" className="md:w-96">
            Linkedin
          </Label>
          <div className="col-span-2">
            <CustomInput
              ...
              onBlur={formik.handleBlur}
              isError={
                formik.touched.linkedIn && formik.errors.linkedIn !== undefined
              }
            />
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <Label htmlFor="profession" className="md:w-96">
            Votre poste
          </Label>
          <div className="col-span-2">
            <CustomInput
              ...
              isError={
                ...
                formik.errors.profession !== undefined
              }
            />
            {formik.touched.profession && formik.errors.profession && (
              <CustomErrorIndicator message={formik.errors.profession} />
            )}
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-1.5 lg:gap-8">
          <div
            className={
              data.skills && data.skills.length > 0 ? 'flex flex-col' : 'flex'
            }
          >
            <Label htmlFor="skills" className="md:w-96">
              Compétences (5 max)
            </Label>
          </div>
          <div className="flex flex-col gap-4 col-span-2">
            <CustomTagInputWithCustomValues
              ...
              isError={
                formik.touched.skills && formik.errors.skills !== undefined
              }
            />
            {formik.touched.skills && formik.errors.skills && (
              <CustomErrorIndicator message={formik.errors.skills as string} />
            )}
          </div>
        </div>
          ...
          <div className="flex flex-col gap-3 w-full col-span-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              {formik.touched.bio && formik.errors.bio && (
                <CustomErrorIndicator message={formik.errors.bio} />
              )}
            </div>
          </div>
        </div>
