...
const OnboardingStepThree = () => {
  ...
  const { isPending, mutateAsync } = useAddUserProfile();
    ...
    onSubmit: async (values) => {
      try {
        ...
        toast.success('Informations enregistrées', {
          description:
            'Vos informations de profil ont été ajoutées avec succès.',
  ...
  return (
    <div className="z-10 flex flex-col items-center gap-8 w-full sm:w-[22.5rem]">
      <div className="flex justify-center items-center size-12 rounded-[0.625rem] border shadow shadow-[#1018280D] border-[#EAECF0]">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-center text-[#475467]">
          Facilitez les échanges en ajoutant vos canaux de communication
          préférés.
        </p>
      </div>
