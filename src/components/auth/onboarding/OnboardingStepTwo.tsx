...
const OnboardingStepTwo = () => {
  const { isPending, mutateAsync: searchCityByName } = useSearchCity();

  const [citySearchResults, setCitySearchResults] = React.useState<
    Array<{
      key: string;
      label: string;
      value: string;
  ...
  const handleCitySearch = async (query: string) => {
    try {
      ...
      const cityItems = response.features.map((feature) => ({
  ...
  return (
    <div className="z-10 flex flex-col items-center gap-8 w-full sm:w-[22.5rem]">
      <div className="flex justify-center items-center size-12 rounded-[0.625rem] border shadow shadow-[#1018280D] border-[#EAECF0] bg-white">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <CustomInput
              ...
              isError={
                ...
                formik.errors.expertise !== undefined
              }
            />
            {formik.touched.expertise && formik.errors.expertise && (
              <CustomErrorIndicator message={formik.errors.expertise} />
            )}
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <CustomTagInputWithDropDown
              ...
              isError={
                formik.touched.desiredJobs &&
                formik.errors.desiredJobs !== undefined
              }
            />
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {formik.touched.city && formik.errors.city && (
              <CustomErrorIndicator message={formik.errors.city} />
            )}
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            {formik.touched.cv && formik.errors.cv && (
              <CustomErrorIndicator message={formik.errors.cv} />
            )}
          </div>
        </div>
