...
export const skillOptions: { key: Skill; value: Skill; label: string }[] = [
  {
    key: Skill.FRONTEND,
    value: Skill.FRONTEND,
    label: 'Frontend (React, Angular, Vue.js, Svelte…)',
  },
  {
    key: Skill.BACKEND,
    value: Skill.BACKEND,
    label: 'Backend (Java, Python, Node.js, PHP, .NET, Ruby…)',
  },
  {
  ...
  {
    key: Skill.FULLSTACK_DEVELOPMENT,
    value: Skill.FULLSTACK_DEVELOPMENT,
    label: 'Fullstack Development',
  },
  {
    key: Skill.LOW_CODE_NO_CODE,
    value: Skill.LOW_CODE_NO_CODE,
  ...
  {
    key: Skill.DATA_SCIENCE_ML,
    value: Skill.DATA_SCIENCE_ML,
  ...
  {
    key: Skill.CLOUD_COMPUTING,
    value: Skill.CLOUD_COMPUTING,
    label: 'Cloud Computing (AWS, Azure, GCP)',
  },
  {
    key: Skill.DEVOPS_CI_CD,
    value: Skill.DEVOPS_CI_CD,
    label: 'DevOps / CI-CD (Docker, Kubernetes, Terraform…)',
  },
  {
    key: Skill.INFRASTRUCTURE_AS_CODE,
    value: Skill.INFRASTRUCTURE_AS_CODE,
  ...
  {
    key: Skill.PRODUCT_MANAGEMENT,
    value: Skill.PRODUCT_MANAGEMENT,
    label: 'Product Management',
  },
  {
    key: Skill.AGILE_METHODOLOGIES,
    value: Skill.AGILE_METHODOLOGIES,
    label: 'Agile / Scrum / Kanban Methodologies',
  },
  {
    key: Skill.IT_PROJECT_MANAGEMENT,
    value: Skill.IT_PROJECT_MANAGEMENT,
    label: 'IT Project Management',
  },
  {
    key: Skill.BUSINESS_ANALYSIS,
    value: Skill.BUSINESS_ANALYSIS,
    label: 'Business Analysis',
  },
  { key: Skill.UI_UX_DESIGN, value: Skill.UI_UX_DESIGN, label: 'UI/UX Design' },
  {
    key: Skill.WEB_DESIGN_INTEGRATION,
    value: Skill.WEB_DESIGN_INTEGRATION,
    label: 'Web Design & Integration',
  },
  {
    key: Skill.PROTOTYPING,
    value: Skill.PROTOTYPING,
    label: 'Prototyping (Figma, Sketch, Adobe XD)',
  },
];
