...
export const industryOptions: {
  ...
  {
    key: Industry.SANTE_PHARMA_BIOTECH,
    value: Industry.SANTE_PHARMA_BIOTECH,
  ...
  {
    key: Industry.BTP_CONSTRUCTION,
    value: Industry.BTP_CONSTRUCTION,
    label: 'BTP & Construction',
  },
  {
    key: Industry.TELECOMS_RESEAUX,
    value: Industry.TELECOMS_RESEAUX,
    label: 'Télécoms & Réseaux',
  },
  {
    key: Industry.ECOMMERCE_RETAIL_LUXE,
    value: Industry.ECOMMERCE_RETAIL_LUXE,
    label: 'E-commerce, Retail & Luxe',
  },
  {
  ...
  {
    key: Industry.EDUCATION_FORMATION,
    value: Industry.EDUCATION_FORMATION,
  ...
  {
    key: Industry.ONG_ECONOMIE_SOCIALE,
    value: Industry.ONG_ECONOMIE_SOCIALE,
    label: 'ONG & Économie sociale',
  },
  {
  ...
  {
    key: Industry.CONSEIL_AUDIT_STARTUPS,
    value: Industry.CONSEIL_AUDIT_STARTUPS,
    label: 'Conseil, Audit & Startups',
  },
];
